const polkadotTypes = (function (exports, util, utilCrypto) {
  ...
  function mapXcm(version) {
    return XCM_MAPPINGS.reduce((all, key) => _objectSpread$p(_objectSpread$p({}, all), {}, {
      [key]: `${key}${version}`
    }), {});
  }
  const xcm = {
  ...
  const definitions$c = {
    rpc: {},
    types: _objectSpread$p(_objectSpread$p(_objectSpread$p(_objectSpread$p(_objectSpread$p(_objectSpread$p(_objectSpread$p({}, location), xcm), v0$1), v1$1), v2), mapXcm(XCM_LATEST)), {}, {
      DoubleEncodedCall: {
        encoded: 'Vec<u8>'
      },
      XcmOriginKind: {
