...
parameter_types! {
	pub const CreateTokenDeposit: Balance = 5;
	pub const CreatePoolDeposit: Balance = 5;
	pub const CreateCollectionDeposit: Balance = 5;
	pub const CreateCurrencyInstanceDeposit: Balance = 5;
