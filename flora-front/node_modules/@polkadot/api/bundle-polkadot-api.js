const polkadotApi = (function (exports, keyring, util, types, definitions, utilCrypto) {
  ...
  ***************************************************************************** */
  ...
  const versioned$7 = [{
    ...
    minmax: [9010, 9099],
    types: _objectSpread$s(_objectSpread$s({}, sharedTypes$3), definitions.mapXcm('V0'))
  }, {
    // jump from 9100 to 9110, however align with Rococo
    minmax: [9100, 9105],
    types: _objectSpread$s(_objectSpread$s({}, sharedTypes$3), definitions.mapXcm('V1'))
  }, {
    // metadata v14
