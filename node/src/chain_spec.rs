...
pub fn development_config(id: ParaId) -> ChainSpec {
	...
	properties.insert("tokenSymbol".into(), "FLORA".into());
...
fn testnet_genesis(
	...
	parachain_template_runtime::GenesisConfig {
		...
		utils_module:Default::default(),
		token_non_fungible: parachain_template_runtime::TokenNonFungibleConfig {
			nft_master: get_account_id_from_seed::<sr25519::Public>("Alice"),
